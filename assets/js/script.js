...
function newQuestion() {
  if (characters.length === 0) {
    alert(`Great job! You have sorted all the students! Your final score is ${correctAnswers}/${questionsAnswered}`);
    return;
  }
...
function checkAnswer(house) {
  if (currentCharacter.house === house) {
    ...
    alert(
      `Sorry, that's wrong.. ${currentCharacter.name} is in ${currentCharacter.house}`
    );
  }
  addAnsweredQuestion();
  newQuestion();
...
// Code to change the color of the buttons onmouseover
btnGryffindor.addEventListener("mouseover", invertColors);
btnHufflepuff.addEventListener("mouseover", invertColors);
btnRavenclaw.addEventListener("mouseover", invertColors);
btnSlytherin.addEventListener("mouseover", invertColors);
btnGryffindor.addEventListener("mouseout", revertColors);
btnHufflepuff.addEventListener("mouseout", revertColors);
btnRavenclaw.addEventListener("mouseout", revertColors);
